...
d = 2.5*size
dt = 1E-16
                                     # before and behind init are double underlines.
class CO_molecule:                   # _init_ behaves like a constructor for a class
    def __init__(self, pos, axis):   # self represents a class’s instance and is required to access any variables or methods within the class.
    ...
    def time_lapse(self, dt):       # by bond's force, caculate a, v, pos, axis of atom after dt
